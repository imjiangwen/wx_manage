...
export default {
    ...
    methods: {
        ...
        getDataList() {
            ...
            this.$http({
                url: this.$http.adornUrl('/msgTemplate/list'),
                method: 'get',
        ...
        deleteHandle(id) {
            ...
            this.$confirm(`确定对[id=${ids.join(',')}]进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
                ...
                this.$http({
                    url: this.$http.adornUrl('/msgTemplate/delete'),
                    method: 'post',
        ...
        syncWxTemplate(){
            ...
            this.$http({
                    url: this.$http.adornUrl('/msgTemplate/syncWxTemplate'),
                    method: 'post',
                    data : {}
                }).then(({ data }) => {
        ...
        addMsgTemplate(msgTemplate){
            return new Promise((resolve, reject) => {
                this.$http({
                    url: this.$http.adornUrl('/msgTemplate/save'),
                    method: 'post',
